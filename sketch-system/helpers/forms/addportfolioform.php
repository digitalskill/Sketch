<ul style="float:right;width:38%;">
    <li>
	<label>Instructions for creating a new Portfolio / Gallery item</label>
	<div class="instruction-box">
	    <p><strong style="font-size:12px;">Enter in the portfolio name : </strong>This name must be unique to the site.</p>
...
<ul class="form accordian" style="float:left;width:60%">
    <li><label></label></li>
    <li><a class="accord-title button"><span class="icons downarrow"></span>Create Portfolio / Gallery Image</a>
	<div class="accord-body">
		...
		<select name="menu_under" class="bgClass:'select_bg'">
        	<?php $r = getData("sketch_page,sketch_menu","*","WHERE page_type='galleryl'"); 
					$counter=0;
					while($r->advance()){ 
						$counter++;
					?>
                   		<option value="<?php echo $r->sketch_menu_id; ?>" <?php if($counter==1){?>selected="selected"<?php } ?>><?php echo $r->menu_name; ?> (PORTFOLIO / GALLERY LISTING PAGE)</option>  
			<?php } ?>
	...
	<select name="page_status" class="bgClass:'select_bg'">
	  ...
	  <option value="member">Members Only</option>
		...
		<select name="page_type" class="bgClass:'select_bg'">
		  ...
		  <option value="gallery" 		selected="selected">Portfolio / Gallery</option>
          ...
          <option value="article"    >Article listing</option>
                ...
                <option value="galleryl"   >Portfolio Listing</option>
		</select>
...
?>
        ...
        <a class="accord-title button"><span class="icons downarrow"></span>Portfolio Page Content</a>
        <div class="accord-body">
        <div class="accord-container">

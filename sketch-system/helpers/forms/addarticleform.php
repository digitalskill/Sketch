...
<ul class="form accordian" style="float:left;width:60%">
    <li><label></label></li>
    <li><a class="accord-title button"><span class="icons downarrow"></span>Create Article page</a>
	<div class="accord-body">
		...
		<select name="menu_under" class="bgClass:'select_bg'">
        	<?php $r = getData("sketch_page,sketch_menu","*","WHERE page_type='article'"); 
					$counter=0;
					while($r->advance()){ 
						$counter++;
					?>
...
?>
        ...
        <a class="accord-title button"><span class="icons downarrow"></span>Article Page Content</a>
        <div class="accord-body">
        <div class="accord-container">
        ...
        <a class="accord-title button"><span class="icons downarrow"></span>Article Listing Content</a>
		<div class="accord-body">
		<div class="accord-container">

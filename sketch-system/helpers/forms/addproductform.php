<ul style="float:right;width:38%;">
    <li>
	<label>Instructions for creating a new Product</label>
...
<ul class="form accordian" style="float:left;width:60%">
    <li><label></label></li>
    <li><a class="accord-title button"><span class="icons downarrow"></span>Create Product page</a>
	<div class="accord-body">
		...
		<select name="menu_under" class="bgClass:'select_bg'">
        	<?php $r = getData("sketch_page,sketch_menu","*","WHERE page_type='productl'"); 
					$counter=0;
					while($r->advance()){ 
						$counter++;
					?>
      ...
      <input type="text" name="page_expiry" value="" class="calender" />
...
?>
        ...
        <a class="accord-title button"><span class="icons downarrow"></span>Product Page Content</a>
        <div class="accord-body">
        <div class="accord-container">
           <label>Product Name</label>
        <input type="text" name="page_heading" value="">
        <label>Product Summary</label>
        <textarea name="leadparagraph" style="height:100px;width:97%"></textarea>
        <label>Product Description</label>
        <textarea name="edit" class="doTiny:true tinySettings:1" id="edit" style="height:300px;width:97%"></textarea>
        </div>
        </div>
        <a class="accord-title button"><span class="icons downarrow"></span>Product Listing Content</a>
		<div class="accord-body">
		<div class="accord-container">
        ...
        <input type="text" name="product_stock" class="integer" value="">
        <label>Product Weight</label>
        <input type="text" name="product_weight" class="decimal" value="">
        <label>Product Price</label>
        <input type="text" name="product_price" class="decimal" value="">
        ...
        <input type="text" name="product_sku"  value="">
		</div>
		</div>
</li>
</ul>

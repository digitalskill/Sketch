           ...
           <form action="<?php echo urlPath(sketch("menu_guid")); ?>" method="post" class="required">
            ...
            <div class="comment-input">
              <p>
                ...
                <input type="text" name="name" value="" id="name" class="required label:'namelbl'">
              </p>
              <p>
                <label for="email" id="emaillbl">Email</label>
                
                <input type="text" name="email" value="" id="email" class="required email label:'emaillbl'">
              </p>
              <p>
                <label for="website" id="weblbl">Website</label>
               
                <input type="text" name="website" value="" id="website" class="label:'weblbl'">
              </p>
            </div>
